    	...
    	<form method="post" id="exam_form">
      		<div class="modal-content">
	        	...
	        	<div class="modal-footer">
	        		...
	        		<input type="hidden" name="admin" value="exam_list" />
...
$(document).ready(function(){
	...
	var dataTable = $('#course_table').DataTable({
        ...
        "ajax":{
            ...
            type:"POST",
			data:{admin_action:'fetch', admin:'exam_list'}
        },
        "columnDefs":[
           {
	...
	$(document).on('click', '.edit', function(){
		...
		$.ajax({
			url:"../DatabaseConn/Ajax_func.php",
			method:"POST",
			data:{admin_action:'edit_fetch', TestId:TestId, admin:'exam_list'},
			dataType:"json",
			success:function(data)
			{
	...
	$('#ok_button').click(function(){
		$.ajax({
			url:"../DatabaseConn/Ajax_func.php",
			method:"POST",
			data:{TestId:TestId, admin_action:'delete', admin:'exam_list'},
			dataType:"json",
			success:function(data)
			{
	...
	$('#ok_button2').click(function(){
		$.ajax({
			url:"../DatabaseConn/Ajax_func.php",
			method:"POST",
			data:{TestId:TestId, admin_action:'change', admin:'exam_list'},
			dataType:"json",
			success:function(data)
			{
	...
	$(document).on('click', '.view', function(){
		...
		$.ajax({
			url:"../DatabaseConn/Ajax_func.php",
			method:"POST",
			data:{admin_action:'To_Question', TestId:TestId, admin:'exam_list'},
			dataType:"json",
			success:function(data)
			{
				location.href = "QuestionList_Admin.php";
			}
		})
